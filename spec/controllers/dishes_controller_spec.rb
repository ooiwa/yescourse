  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dish as @dish" do
        ...
        post :create, {:dish => { "type" => "invalid value" }}, valid_session
        assigns(:dish).should be_a_new(Dish)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dish" do
        ...
        Dish.any_instance.should_receive(:update_attributes).with({ "type" => "" })
        put :update, {:id => dish.to_param, :dish => { "type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dish as @dish" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dish.any_instance.stub(:save).and_return(false)
        put :update, {:id => dish.to_param, :dish => { "type" => "invalid value" }}, valid_session
        assigns(:dish).should eq(dish)
      end
