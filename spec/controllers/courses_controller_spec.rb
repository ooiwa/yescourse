  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved course as @course" do
        ...
        post :create, {:course => { "user_id" => "invalid value" }}, valid_session
        assigns(:course).should be_a_new(Course)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested course" do
        ...
        Course.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => course.to_param, :course => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the course as @course" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Course.any_instance.stub(:save).and_return(false)
        put :update, {:id => course.to_param, :course => { "user_id" => "invalid value" }}, valid_session
        assigns(:course).should eq(course)
      end
